...
Smoking leads to major changes in gene expression, with some genes upregulated up to 26 times. Tryptophan, valine, and isoleucine transport alterations in current smokers reflect impacts on serotonin levels, energy metabolism, and metabolic stress. Oxidative stress from smoking alters post-translational modifications and increases the catabolism of harmful substances, while also impairing mitochondrial electron transport and ATP synthesis, causing energy deficits and cellular damage. Cardiovascular and thyroid functions are affected, influencing sinoatrial node development and thyroid hormone transport.

Ribosomal function and protein synthesis are significantly disrupted by smoking. Impairments in ribosomal biogenesis and function in both dysplasia and current smokers link smoking to increased cancer risk. Dysplasia samples show notable changes in RNA processing, protein synthesis, and mitochondrial function, indicating smoking-related disruptions. Pathways like cytoplasmic translation and peptide chain elongation are particularly affected, contributing to disease development.

Smoking also impacts insulin synthesis and glucose regulation pathways, increasing the risk of insulin resistance and type 2 diabetes. Differences in drug metabolism suggest altered efficacy and toxicity of medications due to smoking. The transport of essential molecules, such as amino acids and thyroid hormones, is affected, impacting nutrient uptake and hormone distribution.

Former smokers show signs of recovery in many cellular processes, including ribosomal function and oxidative phosphorylation, highlighting the benefits of quitting smoking. Overall, our findings underscore the extensive and detrimental effects of smoking on critical biological pathways, contributing to various smoking-related diseases.
